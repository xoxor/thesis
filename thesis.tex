...
\frabstract{
	...
	Dans ce manuscrit, nous proposons deux notions de compromis basées sur une notion de <<equal-loss>>, favorisant un résultat où chaque électeur concède le plus également possible.
