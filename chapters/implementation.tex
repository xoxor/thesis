...
\commentOC{Are you sure? Strange that it does not occur for the bigger ones (or does it?). Do you export in SVG as per the recommendations in \href{https://github.com/oliviercailloux/UML/blob/main/Papyrus/Various.adoc\#graphics-format}{my course}?}
