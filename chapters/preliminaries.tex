...
\commentBN{Not sure whether to introduce here the incompleteness or not. I have the feeling that this chapter is already heavy.}


\section{Voting with rated ballots}
\label{sec:judgmentballots}
TODO: intro about voting with judgments
