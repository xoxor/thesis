...
\commentOC{I’d say this deserves more than one sentence, as it is unclear what you mean exactly and seems like a strong statement. The authors of FB would certainly claim that it is a fair compromising rule.}

Consider an example used by \cite{Luban1985}, 
\commentOC{I’d end the sentence here.}
Rich and Poor are offered $1000$ dollars which they can obtain provided they reach a compromise on how to divide this sum. 
...
\commentOC{You should be more cautious about the opinions that you attribute to Marx; perhaps he has written detailed things on such case which would not lead to exactly that outcome. We see what you mean, but I’d be better to just refer more abstractly to equalitarian conceptions of fairness, or similar wording, than to specific thinkers.}
...
\commentOC{The word “true” is odd here.}
...
Although this sounds very appealing, one of the first \commentOC{main} criticisms of maximin is that it does not satisfy the Pareto criterion. 
\commentOC{You seem to mix Chun’s solution with maximin, these are two different things, AFAICS, as illustrated by the lack of disagreement point in \cref{ex:sen}.}
...
\commentOC{Well, we could obtain them with some supplementary hypothesis about the agents. Your story is also compatible with other utilities (e.g. i gets 1 and 0). This is not a problem with your overall angle, but I’d use a less deductive phrasing here, something about the example being compatible with this story.}
