...
\commentOC{I’d expect the source to have an English title, unless you translated it (you are free to add the original title as well, of course).}\commentBN{I copied the quote from the English version of the book, but I would like to keep the title in Italian as it is the original version. I don't have a very strong opinion about it but I don't think it is too relevant either.}
...
\commentOC{“some of the problems” sounds like you think there are problematic parts in this theory (flaws, unrealistic hypothesis, methodological problems…) and you will indicate which ones, is this your intent?}\commentBN{Yes it is indeed my intent. Maybe flaws or weaknesses are more appropriate terms. But do you mean I should list them here? For example, the inability of many voting rules to find a compromise for me is a flaw and I will use this later to connect to our paper, it is difficult to explain it here.}
...
\commentOC{The scope of the thesis is narrower than CSC! The word “scope” is not the correct one here.}\commentBN{The ambit?}
...
\commentOC{I suggest putting it in a float so as to avoid it being cut oddly.}\commentBN{It was like that at first but I really want it to follow the text. I think it makes more sense within the context because I use it to explain the procedure. I'd honestly prefer odd cuts.} \commentOC{Also, is this your translation? You should then say so. Otherwise, you should also cite the translation.} \commentBN{I translated it, what can I write? Also, isn't it automatically assumed if I don't use a citation.} \commentOC{After thirty the verb should be singular, I suppose; similarly, it should be “those who brag−s−”.} \commentBN{I was trying to be consistent with the original version (also there it is 30 and then the verb at the singular person) but yeah maybe it's stupid.}
\begin{paracol}{2}
	\begin{leftcolumn}
		\centering
...
\commentOC{their methods result quite different is incorrect English.}\commentBN{"With this in mind, we can see that although both Llull and Cusanus wanted to reduce manipulation, the methods they proposed turned out to be quite different."?}
...
REF:
%Pufendorf, Daunou, LaPlace Lhulier, Nanson, Galton, Scitovsky, Bergson, Samuelson
