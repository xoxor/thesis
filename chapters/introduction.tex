...
\commentOC{I do not understand this sentence: why despite, what is “its”?}
...
\commentOC{Aren’t there earlier records? Summerians, e.g.?} where the word democracy itself has it origins from the greek dēmokratiā: dēmos \textit{people} and kratos \textit{rule}. \commentOC{where it has it origins from…?}
...
\commentOC{This analyzis seems a bit brittle to me.}
